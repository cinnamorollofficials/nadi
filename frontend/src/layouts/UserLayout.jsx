  ...
  return (
    <div className="flex h-screen bg-surface overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-surface relative">
        {/* Menu Trigger - Now always available to toggle sidebar visibility/state */}
        <button
          onClick={() => setIsMobileSidebarOpen(true)}
          className="fixed top-4 left-4 z-20 p-3 rounded-2xl bg-surface/80 backdrop-blur-md border border-outline-variant/30 shadow-lg text-surface-on-variant active:scale-95 transition-all duration-300"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <header className="hidden h-16 items-center justify-between px-4 lg:px-6 bg-surface-container-low border-b border-outline-variant/30 sticky top-0 z-10">
