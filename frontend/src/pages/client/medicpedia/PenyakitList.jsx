            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-900 text-white">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
                    ...
                    <p className="text-primary-100 text-lg md:text-xl max-w-2xl mx-auto mb-10 opacity-90 leading-relaxed">
                        Temukan informasi lengkap mengenai penyakit, gejala, penyebab, cara diagnosis dan pencegahannya.
                    </p>
                    {/* Search Bar */}
            ...
            <div className="max-w-5xl mx-auto px-6 py-12">
                ...
                <div className="flex items-center justify-between mb-8">
                    <p className="text-surface-on-variant text-sm">
                        {loading ? 'Memuat...' : (
                            <span>Menampilkan <span className="font-bold text-surface-on">{data.length}</span> dari <span className="font-bold text-surface-on">{totalItems}</span> penyakit</span>
                        )}
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-24">
                        <div className="w-20 h-20 mx-auto mb-6 bg-surface-variant/30 rounded-full flex items-center justify-center">
                            <svg className="w-10 h-10 text-surface-on-variant/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {data.map((item) => (
                            ...
                            >
                                ...
                                <div className="absolute top-4 right-4 w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center">
                                    <span className="text-primary font-black text-lg">{item.name?.[0]?.toUpperCase()}</span>
                                </div>
                                {/* Icon */}
