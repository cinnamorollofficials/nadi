  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-primary-900 text-white p-8 md:p-12 shadow-2xl">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-primary-100 text-lg mb-8 opacity-90 leading-relaxed">
            ...
            access your files, and explore all the features we built for you.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link to="/profile">
              <Button variant="primary" className="bg-white text-primary-900 hover:bg-primary-50 border-none px-6 py-3 rounded-2xl font-bold shadow-lg transition-all active:scale-95">
                Manage Profile
              </Button>
            </Link>
            <Link to="/storage">
              <Button variant="outline" className="border-white/30 text-white hover:bg-white/10 px-6 py-3 rounded-2xl font-bold backdrop-blur-sm transition-all active:scale-95">
                Go to Storage
              </Button>
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          <Card key={i} className="p-6 border border-outline-variant/30 hover:border-primary/20 transition-all duration-300 group hover:shadow-xl hover:shadow-primary/5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="p-8 border border-outline-variant/30">
          ...
          <div className="space-y-4">
             <Link to="/profile" className="flex items-center justify-between p-4 rounded-2xl bg-surface-variant/20 hover:bg-surface-variant/40 transition-all border border-transparent hover:border-outline-variant/20 group">
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <p className="text-xs text-surface-on-variant">Keep your information up to date</p>
                   </div>
                </div>
                <svg className="w-5 h-5 text-surface-on-variant group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
             </Link>
             <Link to="/storage" className="flex items-center justify-between p-4 rounded-2xl bg-surface-variant/20 hover:bg-surface-variant/40 transition-all border border-transparent hover:border-outline-variant/20 group">
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <p className="text-xs text-surface-on-variant">Manage your uploaded files</p>
                   </div>
                </div>
                <svg className="w-5 h-5 text-surface-on-variant group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        <Card className="p-8 border border-outline-variant/30 flex flex-col items-center justify-center text-center space-y-4">
           <div className="w-20 h-20 bg-primary/5 rounded-full flex items-center justify-center">
              <svg className="w-10 h-10 text-primary opacity-40 shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
           ...
           <p className="text-sm text-surface-on-variant max-w-xs mx-auto">
              We're working hard to bring you more features. Stay tuned for updates in your portal!
           </p>
