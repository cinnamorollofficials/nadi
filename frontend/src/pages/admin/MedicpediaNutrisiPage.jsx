...
const MedicpediaNutrisiPage = () => {
  ...
  const tableActions = [
    ...
    ...(can(PERMS.NUTRISI_EDIT) ? [{ label: "Edit", onClick: handleOpenModal }] : []),
    ...(can(PERMS.NUTRISI_DELETE)
      ? [
          {
            label: "Delete",
  ...
  if (!loading && !can(PERMS.NUTRISI_VIEW)) {
