...
const MedicpediaNutrisiPage = () => {
    ...
    const handleExport = async (format) => {
        ...
        try {
            ...
            link.href = url;
            const filename = format === 'csv' ? 'medicpedianutrisi.csv' : 'medicpedianutrisi.xlsx';
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-surface-on tracking-tight">MedicpediaNutrisi Management</h1>
                    <p className="text-sm text-surface-on-variant mt-1">Manage your medicpedianutrisi instances.</p>
                </div>
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4 pt-2">
                    ...
                    <WysiwygEditor
                        ...
                        onChange={(e) => setFormData({ ...formData, daily_needs: e.target.value })}
                        required
                    />
                    <WysiwygEditor
