...
const KafkaServicePage = () => {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-8 animate-in fade-in duration-700">
                ...
                <Card className="p-8 border-none bg-white/5 backdrop-blur-xl ring-1 ring-white/10 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-8">
                        ...
                        <div className="pt-8 border-t border-outline-variant/10 grid grid-cols-2 md:grid-cols-4 gap-8">
                            <div>
                                <p className="text-[10px] font-bold uppercase text-surface-on-variant opacity-50 mb-1">Service Type</p>
                                <p className="text-base font-semibold text-white">Event Bus</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-bold uppercase text-surface-on-variant opacity-50 mb-1">Architecture</p>
                                <p className="text-base font-semibold text-white">Distributed</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-bold uppercase text-surface-on-variant opacity-50 mb-1">Uptime</p>
                                <p className="text-base font-semibold text-white">99.9%</p>
                            </div>
                            <div>
                                <p className="text-[10px] font-bold uppercase text-surface-on-variant opacity-50 mb-1">Latency</p>
                                <p className="text-base font-semibold text-white">~5ms</p>
                            </div>
                        </div>
                    </div>
                </Card>
            ...
            {/* Topics Info */}
            <Card className="p-6 border-none bg-indigo-950/20 rounded-3xl ring-1 ring-white/5">
                <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                        <h4 className="text-sm font-bold text-white">System Pipeline Information</h4>
