...
const BlogPostPage = () => {
    ...
    const tableActions = [
        ...(can(PERMS.UPDATE_BLOGPOST) ? [{ label: 'Edit', onClick: handleOpenModal }] : []),
        ...(can(PERMS.DELETE_BLOGPOST) ? [{ label: 'Delete', onClick: (row) => handleDelete(row.id), className: 'text-error' }] : []),
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-surface-on tracking-tight">BlogPost Management</h1>
                    <p className="text-sm text-surface-on-variant mt-1">Manage your blogpost instances.</p>
                </div>
