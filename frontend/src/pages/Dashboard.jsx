...
const Dashboard = () => {
  ...
  // Statistics data with smooth colors
  const allStats = [
    {
      id: 1,
      title: "Total Users",
    ...
    },
    {
      ...
      iconBg:
        "bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-800/20 dark:to-indigo-800/20",
  ...
  const stats = allStats.filter((s) => hasPermission(s.permission));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-surface-container rounded-2xl border border-outline-variant/30 dark:border-transparent shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-4 space-y-3">
            ...
            {hasPermission(PERMS.MANAGE_CACHE) && (
