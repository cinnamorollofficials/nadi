                ...
                <div className="bg-surface-container rounded-2xl border border-outline-variant/30 shadow-xl overflow-hidden">
                    ...
                    <div className="px-5 py-4 border-b border-outline-variant/20 bg-surface-container-low flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.5 opacity-60">
                            ...
                            <span className="text-[10px] font-bold text-surface-on-variant uppercase tracking-widest">Setup Mode</span>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h1 className="text-xl font-bold text-surface-on">Reset Password</h1>
                            <p className="text-xs text-surface-on-variant mt-1.5 opacity-80">Please enter your new password to restore access.</p>
                        </div>
