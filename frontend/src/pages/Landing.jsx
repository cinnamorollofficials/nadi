        ...
        <div className="bg-navy-950 min-h-screen">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-3/5 text-left pt-10">
                            ...
                            <p className="text-lg md:text-xl text-white/40 max-w-xl mb-12 font-medium leading-relaxed">
                                Platform kesehatan terintegrasi yang menghubungkan Anda dengan layanan medis masa depan melalui teknologi AI dan data yang presisi.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-6">
                                ...
                                <div className="flex -space-x-4">
                                    {[1, 2, 3, 4].map((i) => (
                                        <div key={i} className="w-12 h-12 rounded-full border-2 border-navy-950 bg-navy-800 overflow-hidden ring-2 ring-white/5">
                        ...
                        <div className="lg:w-2/5 w-full">
                            <div className="glass-card rounded-5xl p-8 shadow-2xl shadow-black relative group">
                                ...
                                <h3 className="text-xl font-black text-white mb-6 uppercase tracking-tighter italic">Cek Gejala Kamu</h3>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-wrap gap-2 pt-2">
                                        {['Pusing', 'Demam', 'Batuk', 'Mual'].map(tag => (
                                            <span key={tag} className="text-[10px] font-bold text-white/30 border border-white/5 px-3 py-1.5 rounded-lg hover:text-white/60 hover:bg-white/5 cursor-pointer transition-all uppercase tracking-widest">{tag}</span>
                                        ))}
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-20 border-y border-white/5">
                <div className="container mx-auto px-6 overflow-hidden">
                    <p className="text-center text-[10px] font-black italic uppercase tracking-[0.4em] mb-12 text-white/20">Dipercaya Oleh Institusi Terkemuka</p>
                    <div className="flex flex-wrap justify-center items-center gap-16 md:gap-24 opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
                        {['Biocare', 'Medix', 'Vicare', 'NeuroBeat', 'Health+'].map(name => (
                            <span key={name} className="text-2xl font-black italic uppercase text-white tracking-widest">{name}</span>
                        ))}
                    </div>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-24">
                        <div className="lg:w-1/2">
                            ...
                            <div className="space-y-12">
                                {[
                                    { id: '01', title: 'Input Gejala', desc: 'Sampaikan gejala yang Anda rasakan secara detail untuk analisis awal.' },
                                    { id: '02', title: 'Analisis AI', desc: 'Teknologi AI kami memproses data Anda dengan ribuan database medis.' },
                                    { id: '03', title: 'Hasil Terverifikasi', desc: 'Dapatkan diagnosis akurat dan rekomendasi langkah medis selanjutnya.' }
                                ].map((step) => (
                                    <div key={step.id} className="flex gap-8 group">
                                        <div className="text-4xl font-black text-accent-red/20 group-hover:text-accent-red transition-colors italic leading-none">{step.id}</div>
                                        <div>
                                            <h4 className="text-xl font-black text-white uppercase italic tracking-tighter mb-2">{step.title}</h4>
                        ...
                        <div className="lg:w-1/2">
                            <div className="bg-white rounded-[3rem] p-12 text-black relative shadow-2xl shadow-black overflow-hidden group">
                                ...
                                <h4 className="text-7xl font-black tracking-tighter uppercase italic mb-6">98.4%</h4>
                                <h5 className="text-2xl font-black uppercase tracking-tight mb-8">Akurasi Data Medis</h5>
                                <p className="text-black/60 font-bold mb-12 max-w-sm leading-relaxed">
                                    Kami memanfaatkan machine learning tercanggih untuk memastikan setiap diagnosis memiliki tingkat presisi tertinggi.
                                </p>
                                <div className="flex gap-12 pt-8 border-t border-black/5">
                                    <div>
                                        <div className="text-2xl font-black mb-1">12K+</div>
                                        <div className="text-[10px] font-bold text-black/40 uppercase tracking-widest">Data Terolah</div>
                                    </div>
                                    <div>
                                        <div className="text-2xl font-black mb-1">800+</div>
                                        <div className="text-[10px] font-bold text-black/40 uppercase tracking-widest">Dokter Ahli</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-32 bg-navy-900 border-y border-white/5">
                <div className="container mx-auto px-6 text-center max-w-4xl mx-auto mb-20 px-6">
                    ...
                    <p className="text-white/40 font-medium text-lg leading-relaxed">
                        Kami membangun fondasi kesehatan digital yang menghubungkan semua lini kebutuhan medis Anda dalam satu platform.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="md:col-span-2 glass-card rounded-4xl p-12 group hover:bg-white/5 transition-all h-[450px] flex flex-col justify-end">
                            <div className="w-16 h-16 bg-accent-red/20 rounded-2xl flex items-center justify-center mb-8">
                                <svg className="w-8 h-8 text-accent-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h.01M16 12h.01M8 12h.01M12 16h.01M16 16h.01M8 16h.01" />
                                </svg>
                            </div>
                            <h3 className="text-4xl font-black text-white uppercase italic tracking-tighter mb-6">AI Symptom <br />Checker</h3>
                            <p className="text-white/40 font-medium leading-relaxed max-w-md mb-8">
                                Asisten virtual yang belajar setiap detik untuk membantu Anda mendeteksi potensi penyakit melalui keluhan verbal maupun visual.
                            </p>
                            <Link to="#" className="text-accent-red font-black text-xs uppercase tracking-[0.2em] flex items-center gap-2 group-hover:gap-4 transition-all italic">
                                Pelajari Sistem
                        ...
                        <div className="space-y-6">
                            <div className="glass-card rounded-4xl p-8 group hover:bg-white/5 transition-all">
                                ...
                                <h4 className="text-2xl font-black text-white uppercase italic tracking-tighter mb-2">Nadi Poin</h4>
                                <p className="text-white/40 text-xs font-bold leading-relaxed mb-6">Dapatkan reward untuk setiap gaya hidup sehat yang Anda jalani.</p>
                            ...
                            <div className="glass-card rounded-4xl p-8 group hover:bg-blue-600/10 transition-all border-blue-600/5">
                                ...
                                <h4 className="text-2xl font-black text-white uppercase italic tracking-tighter mb-2">Beli Obat</h4>
                                <p className="text-white/40 text-xs font-bold leading-relaxed">Pengiriman obat resep kilat langsung ke pintu rumah Anda.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-24">
                         <div className="lg:w-1/2 grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={item.title} className="glass-card p-10 rounded-[2.5rem] flex flex-col items-center justify-center text-center group hover:bg-accent-red/5 transition-all cursor-default scale-100 hover:scale-105 active:scale-95 duration-500">
                                    <div className="text-4xl mb-6 transform group-hover:rotate-12 transition-transform">{item.icon}</div>
                                    <div className="text-xs font-black uppercase text-white tracking-widest">{item.title}</div>
                                </div>
                            ))}
                        </div>
                        <div className="lg:w-1/2">
                            <h2 className="text-5xl md:text-6xl font-black text-white uppercase italic tracking-tighter leading-none mb-10">
                                ...
                                Adalah <span className="text-accent-red italic">Prioritas Mutlak</span> Kami.
                            </h2>
                            <p className="text-white/40 font-medium text-lg leading-relaxed mb-12">
                                Kami menerapkan standar keamanan perbankan internasional untuk memastikan setiap riwayat medis dan data pribadi Anda tersimpan dalam enkripsi berlapis.
                            </p>
                            <Button className="border-2 border-white/10 text-white font-black px-10 py-4 uppercase italic tracking-widest text-xs hover:bg-white hover:text-black transition-all">Pelajari Protokol Kami</Button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 border-t border-white/5 bg-navy-900/30">
                <div className="container mx-auto px-6 text-center mb-24 max-w-2xl mx-auto">
                    <h2 className="text-5xl font-black text-white uppercase italic tracking-tighter mb-4">Pertanyaan Umum</h2>
                    <p className="text-white/20 font-bold uppercase tracking-widest text-[10px]">Semua yang perlu Anda ketahui tentang ekosistem kami</p>
                </div>
                
                <div className="container mx-auto px-6 max-w-3xl">
                    <div className="space-y-4">
                        {[
                            'Bagaimana Nadi mengolah data pasien?',
                            'Apakah biaya layanan terjangkau?',
                            'Layanan dokter spesialis ada?',
                            'Bagaimana cara mendaftar?'
                        ].map((q, idx) => (
                            <div key={idx} className="bg-white/5 border border-white/5 rounded-2xl p-6 flex items-center justify-between group hover:bg-white/10 cursor-pointer transition-all">
                                <span className="text-white/60 font-black uppercase italic tracking-tight group-hover:text-white transition-colors">{q}</span>
                                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-accent-red group-hover:text-white transition-all text-white/20">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         ...
                         <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 text-center lg:text-left">
                            <div className="lg:w-3/5">
                                ...
                                <p className="text-white/70 font-bold text-lg md:text-xl">
                                    Bergabunglah dengan <span className="text-white">12.000+</span> pelanggan kami untuk mendapatkan wawasan kesehatan eksklusif setiap hari Rabu.
                                </p>
                            </div>
