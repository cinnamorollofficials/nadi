            ...
            <div className="hidden lg:flex lg:w-[45%] xl:w-[40%] relative overflow-hidden bg-slate-950">
                ...
                <div className="relative z-10 flex flex-col justify-between p-20 w-full h-full">
                    <div className="animate-slide-up">
                        ...
                        <p className="text-slate-400 mt-2 font-medium">Sign in to your {app_name} account</p>
                    </div>
                    ...
                    <div className="max-w-md space-y-6 animate-slide-up">
                        ...
                        <p className="text-lg text-slate-300 font-medium leading-relaxed">
                            Platform kesehatan terintegrasi dengan teknologi AI tercanggih untuk kualitas hidup yang lebih baik.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12 xl:p-24 relative z-10 bg-white dark:bg-slate-950/20">
                ...
                <div className="w-full max-w-sm relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex items-center px-1">
                                <label className="flex items-center cursor-pointer group">
                                    ...
                                    />
                                    <span className="text-[11px] text-surface-on-variant font-medium ml-2">Remember me for 30 days</span>
                                </label>
                            </div>
                            ...
                            <div className="w-full rounded-2xl overflow-hidden border border-outline-variant/30">
                                <GoogleLogin
                                    onSuccess={(credentialResponse) => googleLoginMutation.mutate(credentialResponse.credential)}
                    ...
                    <div className="mt-6 flex items-center justify-center gap-4">
                        ...
                        <span className="w-1 h-1 rounded-full bg-outline-variant/60" />
                        <Link to="/privacy" className="text-[11px] font-bold text-surface-on-variant hover:text-primary uppercase tracking-wider transition-colors">Privacy</Link>
                    </div>
                </div>
            </div>
