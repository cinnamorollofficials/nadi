...
const NotFoundPage = () => {
    return (
        <div className="min-h-screen bg-surface flex flex-col justify-center items-center px-6 relative overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-500/10 rounded-full [100px] pointer-events-none" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary-900/40 rounded-full [100px] pointer-events-none" />
            ...
            <div className="relative z-10 text-center max-w-lg">
                ...
                <div className="mt-10">
                    <Link 
                        to="/" 
                        className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-primary-600 hover:bg-primary-500 text-white font-bold rounded-full transition-all active:scale-95 hover: hover:shadow-primary-600/20"
                    >
